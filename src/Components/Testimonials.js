...
function MySlider() {
    ...
    const Client_array = [
        ...
        {
            logo: "https://www.intellectsoft.net/assets/71e8c840/img/clients-logo/mitsubishi-power.svg",
        },
    ];
            ...
            <div className="mt-20">
                ...
                >
                    {Testimonials_array.map((d) => (
                        <div className="bg-white h-[450px] text-black rounded-xl px-[2px] w-[200px] border-indigo-500">
                            ...
                            <div className="flex flex-col justify-center items-center gap-2 p-4 border-indigo-500 rounded-b-xl border-[2px] h-[200px]">
                                <p>{d.name}</p>
                                <p className="text-center">{d.Feedback}</p>
                                <p>{d.post}</p>
